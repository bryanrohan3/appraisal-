...
const endpoints = {
  ...
  makeOffer: (appraisalId) =>
    `${apiConstants.api_hostname}appraisals/${appraisalId}/make-offer/`,
  passOnOffer: (appraisalId) =>
    `${apiConstants.api_hostname}appraisals/${appraisalId}/pass/`,
};
